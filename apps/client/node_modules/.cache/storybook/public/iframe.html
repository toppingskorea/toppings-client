    ...
    xhr.send(
      ...
      #docs-root[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./.storybook","files":"*.stories.mdx","importPathMatcher":"^\\.[\\\\/](?:\\.storybook\\/(?!\\.)(?=.)[^/]*?\\.stories\\.mdx)$"},{"titlePrefix":"","directory":".","files":"**/*.stories.mdx","importPathMatcher":"^\\.(?:(?:^|\\/|(?:(?:(?!(?:^|\\/)\\.).)*?)\\/)(?!\\.)(?=.)[^/]*?\\.stories\\.mdx)$"},{"titlePrefix":"","directory":".","files":"**/*.stories.@(js|jsx|ts|tsx)","importPathMatcher":"^\\.(?:(?:^|\\/|(?:(?:(?!(?:^|\\/)\\.).)*?)\\/)(?!\\.)(?=.)[^/]*?\\.stories\\.(js|jsx|ts|tsx))$"}];
          
      
          
            window['SERVER_CHANNEL_URL'] = "ws://localhost:6006/storybook-server-channel";</script><script src="runtime~main.iframe.bundle.js"></script><script src="vendors-_yarn___virtual___emotion-react-virtual-19dc7a8f38_0_cache_emotion-react-npm-11_10_5--0cb6b4.iframe.bundle.js"></script><script src="main.iframe.bundle.js"></script></body></html>